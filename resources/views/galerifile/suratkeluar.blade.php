...
@section('title','Galeri File Surat Keluar')
@section('content')
<div class="row mb-5">
    <div class="col">
        <div class="card shadow">
            <form action="{{route('galerikeluar.periode')}}" method="get">
                <div class="card-body">
                    <div class="form-row">
    ...
    <div class="col-4">
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <p><a href="{{route('detail.keluar',$g->id) }}" class="btn btn-success">Lihat isi Surat</a></p>
            </div>
        </div>
    </div>
    @endforeach
